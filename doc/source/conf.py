...
# Import variete just to test that the paths above work
import variete  # noqa
...
project = "variete"
copyright = "2023, variete contributors"
...
extensions = [
    ...
    "sphinx.ext.napoleon",  # Allow numpy docstrings
...
nb_kernel_rgx_aliases = {".*variete.*": "python3"}
...
sphinx_gallery_conf = {
    ...
    "doc_module": ("variete",),  # which function/class levels are used to create galleries
...
html_theme_options = {
    ...
    "use_sidenotes": True,
    "repository_url": "https://github.com/erikmannerfelt/variete",
